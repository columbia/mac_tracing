...
##
	...
	parser.add_option('-b', '--breakpoint',
		...
		metavar = 'BPEXPR',
		#default ='writeSelectionToPasteboard:types:')
		#default ='[NSTextView(NSPasteboard) writeSelectionToPasteboard:types:]')
		default = '-[NSRTFWriter writeBody]')
	...
	parser.add_option('-n', '--normal_end',
		...
		metavar = 'NORMEND',
		default = '__CFRunLoopServiceMachPort')
	...
	try:
		...
		print 'Fail to GetProcessID ', options.pid
...
#		print 'Fail to attach lldb to ', options.pid
	...
	try:
		process.Continue()
		print 'Hit the breakpoint and begin skip and step'
