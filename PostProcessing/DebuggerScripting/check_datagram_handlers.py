...
def check_notification_post(process, debugger, options):
	...
	while True:
		...
		try:
			...
			#print asm_code
			if Begin_record == 1:
				if 'notify_datagram_handler' in top_frame:
			...
			if 'notify_datagram_handler' in top_frame and Begin_record == 0:
				Begin_record = 1
				print "Begin_record handlers"

			if 'retq' in asm_code and 'notify_datagram_handler' in top_frame:
				Begin_record = 0
