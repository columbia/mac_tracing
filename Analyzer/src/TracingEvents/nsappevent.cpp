...
NSAppEventEvent::NSAppEventEvent(double timestamp, string op, uint64_t tid,uint64_t _begin, uint32_t event_core, string procname)
...
void NSAppEventEvent::decode_event(bool is_verbose, ofstream &outfile)
{
...
void NSAppEventEvent::streamout_event(ofstream &outfile)
{
	...
	outfile << "\t" << decode_event_type(event_class);
