...
//codes for parser to divide large log file based on event type/opname
// 0 is reserved
#define MACH_IPC_MSG                1   //MSG_EVENT
#define MACH_IPC_VOUCHER_INFO        2  //VOUCHER_EVENT
#define MACH_IPC_VOUCHER_CONN        3  //VOUCHER_CONN_EVENT
#define MACH_IPC_VOUCHER_TRANSIT    5 //VOUCHER_TRANS_EVENT
#define MACH_IPC_VOUCHER_DEALLOC    6 //VOUCHER_DEALLOC_EVENT
#define MACH_BANK_ACCOUNT            7 
#define MACH_MK_RUN                    8 //MR_EVENT
#define INTR                        9   //INTR_EVENT
//#define WQ_NEXT                        10 //WQNEXT_EVENT
#define MACH_TS                        11 //TSM_EVENT
#define MACH_WAIT                    12  //WAIT_EVENT
#define DISP_ENQ                    13 //DISP_ENQ_EVENT
#define DISP_DEQ                    14 //DISP_DEQ_EVENT
...
namespace LoadData
{
    ...
    //extern std::map<uint64_t, std::pair<pid_t, std::string> > tpc_maps;
