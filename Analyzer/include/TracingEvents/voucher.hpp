...
class VoucherConnectEvent: public EventBase {
    uint64_t voucher_ori;
    uint64_t voucher_new;
public:
    VoucherConnectEvent(double timestamp, std::string op, uint64_t tid, uint64_t voucher_ori, uint64_t voucher_new, uint32_t coreid, std::string procname = "");
...
class VoucherTransitEvent: public EventBase {
    ...
    int type;
public:
    VoucherTransitEvent(double timestamp, std::string op, uint64_t tid, uint64_t voucher_dst, uint64_t voucher_src, uint32_t coreid, std::string procname = "");
...
class VoucherDeallocEvent: public EventBase {
    uint64_t voucher;
public:
    VoucherDeallocEvent(double timestamp, std::string op, uint64_t tid, uint64_t voucher, uint32_t coreid, std::string procname = "");
