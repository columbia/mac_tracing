...
public:
	WqnextEvent(double timestamp, string op, uint64_t tid, uint64_t wq, uint64_t next_thread, uint64_t idle_count, uint64_t req_count, uint32_t coreid, string procname ="");
