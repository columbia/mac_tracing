Installer~\cite{Installer} is an application included in macOS that extracts and installs
...
\vv{lldb}. The main thread sends a synchromous message via \vv{[IFRunnerProxy\
requestKeyForRights:askUser:]} to \vv{authd}.
