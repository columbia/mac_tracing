...
they do not connect the CPU operations back to UI events. Repeated yielding or
...
integrate user input at each stage to leverage hypotheses or expert knowledge
