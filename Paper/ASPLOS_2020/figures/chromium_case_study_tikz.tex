...
\node[draw, dotted, minimum width = 10pt, minimum height = 3pt, below left = -105pt and -30pt of legend, pattern=crosshatch dots, pattern color = black!20!, label= {[font=\large]right: path 2}]{};
...
\node[draw, dotted, minimum width = 10pt, minimum height = 3pt, below left = -120pt and -30pt of legend, label= {[font =\large]right: path 1}]{};
