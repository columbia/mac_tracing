...
\node[draw, dotted, minimum width = 10pt, minimum height = 3pt, below left = -90pt and -30pt of legend, pattern=crosshatch dots, pattern color = black!20!, label= right: flow of message]{};
