...
\node [draw, solid, minimum width = 10pt, minimum height = 3pt, below left = -50pt and -30pt of legend, label={[font=\large]right:thread (vertex)}]{};
\node [solid, minimum width = 10pt, minimum height = 3pt, below left = -60pt and -30pt of legend, label={[font=\large]right:execution in}]{};
