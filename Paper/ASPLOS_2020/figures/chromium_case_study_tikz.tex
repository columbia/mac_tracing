...
\tikzstyle{blocked} = [minimum height = 10pt, pattern=north west lines, pattern color = black!40!, font=\scriptsize, rotate=270] 
...
\node[draw, dotted, above left = -50pt and -170pt of 9, pattern=crosshatch dots, pattern color = black!20!, minimum width =180pt, minimum height=60pt]{}; %label=below:flow of Javascript running]{};
...
\node(legend)[above right = 10pt of fontdend]{};
...
\node (l7)[below left = -40pt and -20pt of legend] {};
\node (l8)[right =8pt of l7, point]{};
\draw [->, dotted] (l7.east) -- (l8);
\node [right =10pt of l7, font=\large]{Missing edge};

\node [solid, minimum width = 10pt, minimum height = 3pt, below left = -60pt and -30pt of legend, label={[font=\large]right:thread (vertex)}]{};
\node [draw, solid, minimum width = 10pt, minimum height = 3pt, below left = -70pt and -30pt of legend, label={[font=\large]right:execution in}]{};

\node[minimum width = 10pt, minimum height = 3pt, below left = -80pt and -30pt of legend,label= right: flow of message]{};
\node[draw, dotted, minimum width = 10pt, minimum height = 3pt, below left = -90pt and -30pt of legend, pattern=crosshatch dots, pattern color = black!20!, label= right: for Javascript]{};
