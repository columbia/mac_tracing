...
\node (InteractiveDebugger) [systemComp, rounded corners=20pt, minimum height=250pt, minimum width=280pt, below left = 20pt and -160pt of log] {};
...
\node(rdm2) [gnode, thick, fill = blue!20, minimum height = 10pt, below = 18pt of rdm1, font=\scriptsize]{msg\\sema\_wait};
...
\node (user)[alice, minimum size=30pt, left = 100pt of InteractiveDebugger]{};
