...
\node (blockbrowser) [draw, solid, minimum height = 10pt, fill=black!20, below left = -80pt and -200pt of result, label=below:browser thread blocks on condition variable]{msg cv\_wait};
