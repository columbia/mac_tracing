...
\subsection{Motivating Example: Chromium Spinning Cursor}
...
chromium + scim shipped with macos, spinning cursor
difficult to debug: where is the culprit?
daemons: fontd, preferenced
total threads:

60 messages under bug report
developers cannot figure out why
