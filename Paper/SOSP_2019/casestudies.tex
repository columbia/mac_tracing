...
and illustrated the root causes for two cases which triggered the spinning wait cursor.
As we have illustrated the Chromium case in Section\ref{sec:overview}, we will not
