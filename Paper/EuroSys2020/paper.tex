...
\usepackage{color}
\usepackage{bbding, pifont, amsfonts}
...
\newcommand{\para}{\vspace{-0.15cm}\paragraph}
\newcommand{\wrt}{{w.r.t. }}
\newcommand{\cf}{{cf. }}
\newcommand{\etal}{{et al. }}
\newcommand{\vv}[1]{{\textit{#1}}}
\newcommand{\mycheck}[0]{\ding{51}}
\newcommand{\mycross}[0]{\ding{55}}
...
\newcommand{\appinsight}[0]{AppInsight\xspace}
\newcommand{\panappticon}[0]{Panappticon\xspace}
...
\newcommand{\napps}[0]{11\xspace}
\newcommand{\nbug}[0]{11\xspace}
\newcommand{\cpuoverhead}[0]{3.36\%\xspace}
\newcommand{\IOoverhead}[0]{3.97\%\xspace}
...
\algrenewcommand\algorithmiccomment[1]{\commentsymbol{} #1}
