...
\item We build \xxx, performing scalable system-wide causal tracing with little overhead,
and design its diagnosis algorithm with comparision to normal cases.

\item We use it to 
diagnose real-world spinning cursors and find root causes for
