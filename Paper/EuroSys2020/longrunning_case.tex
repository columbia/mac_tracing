...
around 500 items in a \vv{TeXStudio} tab. Each time when we touch the file in
other editors like vim, a spinning cursor appears in the application's window.
