#!/bin/bash
clang -arch x86_64 -arch i386 -Wall -dynamiclib hack_lib.c hook_CoreFoundation.c patch_CoreFoundation.c -include lib_mach_info.h -framework CoreFoundation -current_version 1258.1.0 -compatibility_version 150.0.0 -Xlinker -reexport_library /usr/local/lib/libRatings.A.dylib -o HookCoreFoundation
