...
0x120002c	MACH_IPC_msg_link
0x1200030	MACH_IPC_voucher_reuse
0x1200034	MACH_IPC_voucher_conn
0x1200038	MACH_IPC_voucher_remove
0x120003c	MACH_IPC_voucher_info
0x1200044	MACH_IPC_msg_dump
0x1200048	MACH_IPC_msg_boarder
0x120004c	MACH_IPC_msg_dsc
0x1200050	MACH_IPC_msg_trap
0x1200054	MACH_IPC_msg_idsc
0x1200058	MACH_IPC_msg_thread_voucher
...
0x1400104	MACH_WAIT_REASON
0x1400108	MACH_WAKEUP_REASON
0x140010C	MACH_TS_MAINTENANCE
0x1400110	MACH_CALLCREATE
0x1400114	MACH_CALLCANCEL
...
0x7020014	TRACE_INFO_NEWTHREAD
0x8000000	USER_TEST
0x8000004	USER_run
0x8000008	USER_join
...
0x8040000	USER_STOP
0x9000040	wq__pthread_thread_create
0x9000080	wq__pthread_thread_terminate
0x90000c0	wq__pthread_set_qos_self
...
0x9010004	wq__pthread_exit
0x9010008	wq__workqueue_exit
0x901000c	wq__run_nextitem
0x9010010	wq__runitem
0x9010014	wq__req_threads
0x9010018	wq__req_octhreads
0x901001c	wq__thread_suspend
0x9010020	wq__thread_park
0x9010024	wq__thread_block
0x9010028	wq__new_max_scheduled
0x901002c	wq__add_timer
0x9010030	wq__start_add_timer
0x9010034	wq__stalled
0x9010038	wq__reset_priority
0x901003c	wq__thread_yielded
0x9010040	wq__delay_octhreads
0x9010044	wq__overcommitted
0x9010048	wq__override_start
0x901004c	wq__override_end
0x9010050	wq__override_dispatch
0x9010054	wq__override_reset
0x9010058	wq__req_event_manager
0x901005c	wq__kevent_req_threads
0x9010060	wq__req_kevent_threads
0x9010064	wq__req_kevent_octhreads
0x9010068	wq__thread_limit_exceeded
0x901006c	wq__thread_constrained_maxed
0x9010070	wq__thread_add_during_exit
0x9010074	wq__thread_create_failed
0xa000100	P_CS_Read
...
0x2810000c	Bank_Account_redeem
0x29000004  XPC_Packing_begin  
0x29000008  XPC_Packing_end    
0x2900000c  XPC_Unpacking_slow_begin
0x29000010  XPC_Unpacking_slow_end
0x29000014  XPC_Unpacking_begin
0x29000018  XPC_Unpacking_end  
0x2900001c  XPC_Transaction_begin
0x29000020  XPC_Transaction_end 
0x29000024	XPC_Transaction_sc_begin
0x29000028	XPC_Transaction_sc_end
0x2900002c	XPC_Init_begin
0x29000030	XPC_Init_end
0x29000034	XPC_collect_images_begin
0x29000038	XPC_collect_images_end
0x2900003c	XPC_uncork_domain_begin
0x29000040	XPC_uncork_domain_end
0x29000060	XPC_Create_reply
0x29000064	XPC_Send_msg
0x29000068	XPC_Send_with_reply
0x2900006c	XPC_Send_sync_reply
0x29000070	XPC_Objectdump
0x29000090  MSG_Pathinfo
0x29000094	MSG_Backtrace
